...
// Constants for Chartered Evidence Hub PoC
export const POC_COMPETENCIES: PocCompetency[] = [
  { id: "POC_A1", title: "POC_A1: Application of Knowledge", description: "Demonstrating engineering knowledge and understanding." },
  { id: "POC_B2", title: "POC_B2: Problem Solving", description: "Identifying, analyzing, and solving engineering problems.", isAmberByDefault: true }, // To demo Amber
  { id: "POC_C3", title: "POC_C3: Leadership & Management", description: "Managing projects, resources, or teams." },
  { id: "POC_D4", title: "POC_D4: Communication", description: "Effective communication with various stakeholders.", isAmberByDefault: true }, // To demo Amber
  { id: "POC_E5", title: "POC_E5: Professional Commitment", description: "Adhering to ethical principles and professional standards." },
  { id: "POC_F6", title: "POC_F6: Design and Development", description: "Designing and developing solutions." },
  { id: "POC_G7", title: "POC_G7: Sustainability and Safety", description: "Incorporating sustainability and safety in engineering practice." },
];

// Simplified RAG status definitions for PoC
...
// Tailwind classes for PoC RAG status visual indicators (e.g., text color or background for badges/dots)
export const POC_RAG_CLASSES: Record<PocRAGStatus, { text: string; bg: string; border: string; dot: string; }> = {
  [PocRAGStatus.Green]: {
    text: "text-green-700 dark:text-green-300",
    bg: "bg-green-100 dark:bg-green-700/30",
    border: "border-green-500 dark:border-green-400",
    dot: "bg-theme-accent-green dark:bg-dark-theme-accent-green"
  },
  [PocRAGStatus.Amber]: {
    text: "text-amber-700 dark:text-amber-300",
    bg: "bg-amber-100 dark:bg-amber-700/30",
    border: "border-amber-500 dark:border-amber-400",
    dot: "bg-theme-accent-amber dark:bg-dark-theme-accent-amber"
  },
  [PocRAGStatus.Red]: {
    text: "text-red-700 dark:text-red-300",
    bg: "bg-red-100 dark:bg-red-700/30",
    border: "border-red-500 dark:border-red-400",
    dot: "bg-theme-accent-red dark:bg-dark-theme-accent-red"
  },
};

// Allowed file types for PoC upload
export const POC_ALLOWED_FILE_TYPES = {
  'application/pdf': '.pdf',
  ...
  'image/svg+xml': '.svg',
  'application/zip': '.zip',
  'application/x-zip-compressed': '.zip', // common for zip
};
export const POC_MAX_FILE_SIZE_MB = 5; // Max file size for PoC (Data URLs can get large)
